      ...
      {isOpen && (
        <div ref={menuRef} className="absolute right-14 top-2 z-40">
          <ul
            ...
            className="dark:bg-black bg-gray-100 rounded-lg overflow-hidden border border-slate-300 dark:border-slate-700 shadow-lg"
          >
            <Options
...
const Options = (data: { label: string; onClick: VoidFunction }) => {
  return (
    <li className="hover:dark:bg-blue-600 hover:bg-blue-100 p-2">
